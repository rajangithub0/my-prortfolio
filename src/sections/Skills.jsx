...
export default function Skills() {
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      ([entry]) => {
        setActive(entry.isIntersecting && entry.isIntersecting > 0.1);
      },
      {
        threshold: [0.1],
      },
  ...
  return (
    ...
    >
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className=" absolute bottom-1/4 right-0 w-75 h-75  rounded-full bg-linear-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8d2] opacity-20 blur-[120px] animate-pulse" />
      </div>
      <motion.h2
      ...
      <div className=" relative w-full overflow-hidden">
        <motion.div
          ...
          style={{x,whiteSpace:"nowrap",willChange:"tranform  j"}}
        >
          {repeated.map((s, i) => (
            <div
              key={i}
