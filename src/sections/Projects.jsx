      ...
      <div className="sticky top-0 h-screen flex flex-col items-center">
        ...
        <h2
          className="absolute top-6 sm:top-8 left-1/2 -translate-x-1/2 
                       text-3xl font-semibold z-20 text-center"
        >
          My Work
        </h2>
            ...
            >
                ...
                {activeIndex === idx && (
                  <motion.h3
                    ...
                    className={`block italic font-semibold
                      text-[clamp(2rem,6vw,5rem)] text-white/95
                      text-center sm:absolute sm:-top-20
              ...
              >
                <img
                  ...
                  style={{
                    filter: "drop-shadow(0 60px 40px rgba(0,0,0,0.65))",
        ...
        <div className={`absolute ${isMobile ? "bottom-20" : "bottom-10"}`}>
          <a
            ...
            className="inline-block px-6 py-3 font-semibold rounded-lg bg-white text-black hover:bg-gray-100 transition-all"
