...
const socials = [
  ...
  //   Icon: FaYoutube,
  //   label: "YouTube",
  //   href: "https://www.youtube.com/@gauravbitss",
  // },
  { Icon: FaXTwitter, label: "X", href: "https://x.com/Rajan_rana_" },
  {
    Icon: FaLinkedinIn,
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/-rajan-rana-/",
  },
  {
    Icon: FaInstagram,
    label: "Instagram",
    href: "https://www.instagram.com/programcodrr/",
  },
  {
    Icon: FaGithub,
    label: "GitHub",
    href: "https://github.com/rajangithub0",
  },
];
    ...
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Rajan. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
