...
export default function About() {
  ...
  const glows = [
    ...
    "top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[220] h-[200px] opacity-10 blur-[100px] delay-500",
  ];
    ...
    <>
      ...
      >
        ...
        <div className=" relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
          <motion.div
            className=" flex flex-col md:flex-row item-center md:items-stretch gap-8 "
          ...
          >
            <motion.div
              className=" relative w-40 h-40 md:w-50px h-50px rounded-2xl overflow-hidden shadow-2xl bg-linear-to-br from-[#1cd8d2]/20 to-[#302b63]/25 border-[#1cd8d2]"
            ...
            <div className="flex-1 flex flex-col justify-center text-center md:text-left">
              ...
              <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
                I build scalable, modren application with a strong focus on
                clean .
              </p>
